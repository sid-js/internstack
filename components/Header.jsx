...
import InternstackLogo from "../public/internstack-logo.svg"
import {
...
const Header = () => {
  ...
  return (
    <Navbar border fluid className="w-full">
      <Navbar.Toggle />
      <Navbar.Brand href="/">
        <Image
      ...
      <Navbar.Collapse className="absolute left-0 z-50 px-2 rounded-md top-20 bg-slate-100 md:hidden">
        <Navbar.Link
